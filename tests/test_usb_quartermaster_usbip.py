from USB_Quartermaster_Usbip import __version__
...
from USB_Quartermaster_Usbip import UsbipOverSSHHost
from USB_Quartermaster_common import CommandResponse
